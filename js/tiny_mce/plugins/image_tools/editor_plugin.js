        ...
        init : function(ed, url) {
            ...
            ed.addCommand('mceImageFloatLeft', function() {
                ...
                if (el.nodeName == 'IMG'){
                    ...
                    tinymce.DOM.removeClass(el.parentNode, 'float_left');
                    tinymce.DOM.addClass(el, 'float_left');
                    if(el.parentNode.className.indexOf("imgdiv") !== -1) {
                        tinymce.DOM.addClass(el.parentNode, 'float_left');
                        tinymce.DOM.removeClass(el.parentNode, 'float_right');
                    }
                }
            ...
            ed.addCommand('mceImageFloatRight', function() {
                ...
                if (el.nodeName == 'IMG'){ 
                    ...
                    if(el.parentNode.className.indexOf("imgdiv") !== -1) {
                        tinymce.DOM.addClass(el.parentNode, 'float_right');
                        tinymce.DOM.removeClass(el.parentNode, 'float_left');
                    }
                }
                ed.execCommand("mceRepaint");
            ...
            ed.addCommand('mceImageImageSizePlus', function() {
                ...
                if (el.nodeName == 'IMG'){ 
                    ...
                    if(el.parentNode.className.indexOf("imgdiv") !== -1) {
                        el.parentNode.setAttribute("data-mce-style","width: "+el.width+"px");
                        el.parentNode.style.width = el.width;
                    }
