...
<div class="pull-right" id="school_selects">
	<ul class="navlist">
		...
		<li class="hl-blue" ><label for="sel_art">ART 			</label><input id="sel_art" type="checkbox" class="sel_school push-right" value="Architecture" checked></li>
		<li class="hl-red"  ><label for="sel_arc">ARCHITECTURE 	</label><input id="sel_arc" type="checkbox" class="sel_school push-right" value="Art" checked></li>
